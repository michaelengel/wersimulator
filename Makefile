...
OBJS= console.o dis6809.o emu6809.o inst6809.o int6809.o memory.o \
      misc.o miscutils.o intel.o motorola.o binary.o mirage_hw.o wersi_mk1_hw.o
...
motorola.o: motorola.c config.h emu6809.h

binary.o: binary.c config.h emu6809.h

mirage_hw.o: mirage_hw.c config.h console.h

wersi_mk1_hw.o: wersi_mk1_hw.c config.h console.h
